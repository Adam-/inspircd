...
class CommandLockserv : public Command
{
 ...
 public:
	...
	CmdResult Handle (const std::vector<std::string> &parameters, User *user)
	{
		...
		SnomaskManager::WriteGlobalSno(SnomaskManager::announcement, "Oper %s used LOCKSERV to temporarily disallow new connections", user->nick.c_str());
		return CMD_SUCCESS;
	}
};
...
class CommandUnlockserv : public Command
{
 ...
 public:
	...
	CmdResult Handle (const std::vector<std::string> &parameters, User *user)
	{
		...
		SnomaskManager::WriteGlobalSno(SnomaskManager::announcement, "Oper %s used UNLOCKSERV to allow new connections", user->nick.c_str());
		return CMD_SUCCESS;
	}
};
