...
void TreeServer::FinishBurst()
{
	...
	if (Parent == Utils->TreeRoot)
		SnomaskManager::WriteToSnoMask(Utils->Creator->link, "Received end of netburst from \2%s\2 (burst time: %lu %s)",
		GetName().c_str(), (bursttime > 10000 ? bursttime / 1000 : bursttime), (bursttime > 10000 ? "secs" : "msecs"));
	else
		SnomaskManager::WriteToSnoMaskRemote(Utils->Creator->link, "Received end of netburst from \2%s\2 (burst time: %lu %s)",
		GetName().c_str(), (bursttime > 10000 ? bursttime / 1000 : bursttime), (bursttime > 10000 ? "secs" : "msecs"));
