...
IF (MYSQL_INCLUDE_DIR AND MYSQL_LIB_DIR)
  ...
  ENDIF()
  IF (MYSQL_ZLIB)
    SET(MYSQL_LIBRARIES ${MYSQL_LIBRARIES} zlib)
  ENDIF (MYSQL_ZLIB)
  IF (MYSQL_TAOCRYPT)
    SET(MYSQL_LIBRARIES ${MYSQL_LIBRARIES} taocrypt)
  ENDIF (MYSQL_TAOCRYPT)
  # Added needed mysqlclient dependencies on Windows
  IF (WIN32)
    SET(MYSQL_LIBRARIES ${MYSQL_LIBRARIES} ws2_32)
  ENDIF (WIN32)

  include(FindPackageHandleStandardArgs)
  find_package_handle_standard_args(libmysqlclient DEFAULT_MSG
    MYSQL_LIBRARIES
    MYSQL_INCLUDE_DIR
  )
