...
RUN apt-get install -y libgnutls28-dev pkg-config libldap2-dev libpcre3-dev libmariadbclient-dev libpq-dev libsqlite3-dev zlib1g-dev libgeoip-dev libtre-dev
